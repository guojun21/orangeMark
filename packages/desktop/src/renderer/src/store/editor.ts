...
export const useEditorStore = defineStore('editor', {
  ...
  actions: {
    ...
    NEW_UNTITLED_TAB({
      ...
      // New documents are materialized in the project immediately. The
      // existing directory watcher opens the resulting markdown file as a
      // normal path-backed tab, so no untitled buffer can escape the project.
      void projectStore.CREATE_PROJECT_FILE(markdownString ?? '')
    },
